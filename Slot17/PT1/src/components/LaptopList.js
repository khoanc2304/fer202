...
function LaptopList() {
  ...
  useEffect(() => {
    ...
    } else { const filtered = allLaptops.filter((l) =>
  ...
  return (
    <Container className="py-5">
      ...
      <Form className="d-flex justify-content-center mb-4">
        <Form.Control  type="text" placeholder="Search by brand or model..."
 style={{ maxWidth: "300px" }}  value={search}   onChange={(e) => setSearch(e.target.value)} />
      </Form>
          ...
          <Col key={laptop.id}>
            <Card className="h-100 shadow-sm rounded">
              ...
              <Card.Body className="d-flex flex-column">
                ...
                <Card.Text>Year: {laptop.year} <br />   Price: {laptop.price}</Card.Text>
